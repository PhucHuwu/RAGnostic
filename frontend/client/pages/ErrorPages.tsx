...
export const Error403 = () => (
  <ErrorPageTemplate
    ...
    description="Bạn không có quyền truy cập trang này. Liên hệ với quản trị viên nếu bạn cho rằng đây là lỗi."
    icon={<Lock className="w-10 h-10 text-destructive" />}
  />
);
...
export const Error500 = () => (
  <ErrorPageTemplate
    code="500"
    title="Lỗi máy chủ"
    description="Rất tiếc, có lỗi xảy ra trên máy chủ. Chúng tôi đang khắc phục sự cố này. Vui lòng thử lại sau."
